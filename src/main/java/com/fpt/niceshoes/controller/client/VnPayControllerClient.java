...
import com.fpt.niceshoes.infrastructure.vnpay.VNPayConfig;
...
@RestController
@RequestMapping(value = "/client/api/vn-pay")
public class VnPayControllerClient {
    ...
    public ResponseObject payment(String id, String total) {
        ...
        vnp_Params.put("vnp_ReturnUrl","http://localhost:3006" + VNPayConfig.vnp_Returnurl);
